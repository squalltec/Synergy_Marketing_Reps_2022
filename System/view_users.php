   ...
   <!-- Right side column. Contains the navbar and content of the page -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           View Franchisee Users
            
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Franchisee </a></li>
            <li class="active">View Franchisee Users</li>
          </ol>
        </section>
...
$sqlla ="SELECT * FROM users WHERE DEL='0' && role!='admin'";
...
<div onclick="location.href='update_user.php?dan=<?php echo $rowwa['id'];?>';" style="cursor: pointer;" align="center" class="containeer gallery">



    <img src="Fuser Images/<?php echo $rowwa["image"];?>" alt="">
 
 
 <div style='line-height:10pt;' class="pp">
 <p align="center" class="f" style="font-size:100%;"><?php echo $rowwa["name"];?></p>

  <p align="center" class="f" style="font-size:100%;"><?php echo $rowwa["company"];?></p>
