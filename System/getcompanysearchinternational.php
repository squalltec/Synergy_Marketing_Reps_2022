...
$sqllas = "SELECT * FROM international_company WHERE (companyname LIKE '%$srch%' OR speciality LIKE '%$srch%' OR country LIKE '%$srch%' OR city LIKE '%$srch%' OR phone LIKE '%$srch%' OR website LIKE '%$srch%') && DEL='0'";
...
<div onclick="location.href='edit_international_company.php?dan=<?php echo $row['id'];?>';" style="cursor: pointer;" align="center" class="containeer gallery">



    <img src="International Company Lisences/<?php echo $row["logo"];?>" alt="">
