...
<div id='listing' style="margin-left:2%; margin-right:2%; margin-top:4%;" class='notranslate' align="center">
    		...
    		<?php	
				...
				$companyn=$_SESSION['company'];
		
$sqlla ="SELECT * FROM users WHERE DEL='0' && company='$companyn'";
...
<div onclick="location.href='update_user_owner.php?dan=<?php echo $rowwa['id'];?>';" style="cursor: pointer;" align="center" class="containeer gallery">
