...
$sqlla ="SELECT * FROM customer WHERE DEL='0' && createdbycompanyid='$usidd'";
...
<div onclick="location.href='update_customers_owner.php?dan=<?php echo $rowwa['id'];?>';" style="cursor: pointer;" align="center" class="containeer gallery">
