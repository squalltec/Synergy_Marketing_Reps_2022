...
$sqlla ="SELECT * FROM international_customer WHERE DEL='0'";
...
<div onclick="location.href='update_international_customers.php?dan=<?php echo $rowwa['id'];?>';" style="cursor: pointer;" align="center" class="containeer gallery">
