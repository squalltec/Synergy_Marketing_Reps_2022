...
$sqllas = "SELECT * FROM office WHERE (companyname LIKE '%$srch%' OR companyemail LIKE '%$srch%' OR country LIKE '%$srch%' OR city LIKE '%$srch%' OR phone LIKE '%$srch%' OR website LIKE '%$srch%'  OR owner LIKE '%$srch%') && DEL='0'";
...
<div onclick="location.href='update_company.php?dan=<?php echo $row['id'];?>';" style="cursor: pointer;" align="center" class="containeer gallery">



    <img src="General Lisences/<?php echo $row["logo"];?>" alt="">
