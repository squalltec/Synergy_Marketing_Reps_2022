...
$sqlla ="SELECT * FROM international_company WHERE DEL='0'";
...
<div onclick="location.href='edit_international_company.php?dan=<?php echo $rowwa["id"];?>';" style="cursor: pointer;" align="center" class="containeer gallery">
