...
$sqll ="SELECT * FROM users WHERE id='$personname'";
...
<a href="view_users_owner.php">Staff</a>
...
<a href="view_local_company_owner.php">Local Companies</a>

</li>
                   
                   <li> 
                   <a href="view_customers_owner.php"> Local Customers</a></li>
                   
                   
                   
                    <li> 
                   <a href="view_international_companies_owner.php"> International Companies</a></li>
                   
                   
                   
                    <li> 
                   <a href="view_customers_international_owner.php"> International Customers</a></li>
...
<!--			 <select style='color:black;' class="notranslate" id="selectBox" onchange="changeFunc();">
    ...
    <option value="ar">عربي</option>
            ...
            -->    
                ...
                <a style='display:inline;' href="whatsappowner" class="dropdown-toggle2">
                     <span style='margin-top:10px; z-index:1;' id='countmsgs' class="label label-warning "></span>
                 <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
...
<lord-icon
    ...
    delay="5"
    colors="primary:#000000"
    style="margin-top:12px !important; margin-right:-35px !important;  float:left; width:25px;height:25px">
</lord-icon>
...
<lord-icon
    ...
    style="margin-top:12px !important; margin-right:-35px !important;  float:left;  width:25px;height:25px">
               ...
               <!-- Notifications: style can be found in dropdown.less -->
              <li id='VC' class="vccc dropdown notifications-menu">
            ...
            .small-box{
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="Fuser Images/<?php echo $roww['image'];?>" class="user-image" alt="User Image"/>
                 
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li style=' border-radius:5%;'  class="user-header">
                    <img src="Fuser Images/<?php echo $roww['image'];?>" class="img-circle" alt="User Image" />
                    <p>
                      <?php echo $roww['name'];?>
                    ...
                    <br/>
                    <a href="owner_profile.php" style="border-radius:12px;" class="btn btn-default btn-flat">Manage your Account</a>
                    <br/>
...
<span>Dashboard</span>
              ...
              <ul class="treeview-menu">
                <li id='CFU'><a href="create_user_owner.php"><i class="fa fa-users"></i> Create Staff</a></li>
...
<lord-icon
    ...
    style="float:left; width:25px;height:25px">
              ...
              <ul class="treeview-menu">
                <li style='display:inline;' class='cr'><a href="create_local_company_owner.php">
                    <br/>
...
Create Client Company</a></li>
                <li style='display:inline;'><a class='cr2' href="create_customer_owner.php">
                       <br/>
                    <lord-icon
    src="https://cdn.lordicon.com/auvicynv.json"
    class='hidecr2'
...
<lord-icon
    ...
    style="float:left; width:25px;height:25px">
              ...
              <ul class="treeview-menu">
                <li style='display:inline;' class='cr'><a href="create_international_company_owner.php">
                    <br/>
...
Create Client Company</a></li>
                <li style='display:inline;'><a class='cr2' href="create_customer_international_owner.php">
                       <br/>
                    <lord-icon
    src="https://cdn.lordicon.com/auvicynv.json"
    class='hidecr2'
  ...
  <li id='APPON' class="treeview">
            ...
            <li id='CA' class="treeview">
              ...
              <ul class="treeview-menu">
                   ...
                   <li style='color:white;' class='sign'><a href='qr/example.php'><i class="fa fa-plus"></i>Visiting Card</a></li>
                   
                    <li style='color:white;' class='sign'><a href='qr/emailsign.php'><i class="fa fa-plus"></i>Email Signature</a></li>
