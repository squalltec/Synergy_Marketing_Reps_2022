	   ...
	   <!-- phone mask -->
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input required  type="text" name="phone"class="form-control"/></div></div>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
