...
$sqlla ="SELECT * FROM international_customer WHERE DEL='0' && createdbycompanyid='$usidd'";
...
<div onclick="location.href='update_international_customers_owner.php?dan=<?php echo $rowwa['id'];?>';" style="cursor: pointer;" align="center" class="containeer gallery">



    <img src="International Customer Images/<?php echo $rowwa["image"];?>" alt="">
...
?>
 ...
 $.ajax({
              type:'POST',
              url:'getcustomerinternationalsearch.php',
              data:{'srch':srch},
