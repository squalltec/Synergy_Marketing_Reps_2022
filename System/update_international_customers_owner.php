...
$sql ="UPDATE international_customer SET name='$name',email='$email',password='$password',username='$username',phone='$phone',country='$country',designation='$designation',city='$city',department='$department',birthday='$birthday',website='$website',zoom='$zoom',relevantinformation='$relevantinformation',interests='$interests',likesdislikes='$likesdislikes' WHERE id='$dan'";
...
if ($result === TRUE) {
  ...
  echo "Error: " . $sql . "<br>" . $conn->error;
	  ...
	  $destination = 'International Customer Images/'. $filename;
...
$sqll ="SELECT * FROM international_customer WHERE id='$dan'";
...
if ($resultt->num_rows > 0) {
  ...
  while($roww = $resultt->fetch_assoc()) {
            ...
            <img src="International Customer Images/<?php echo $roww['image'];?>" id="dp" class="" alt="" style="width:50px; height:50px;">
			</br>
			</br>
...
?>
        ...
        <a href="del.php?iduser=<?php echo $roww['id'];?>&tbuser=international_customer"> <button style="background-color:red; float:left;" name="Delete" class="btn btn-primary"> Delete </button></a> 
