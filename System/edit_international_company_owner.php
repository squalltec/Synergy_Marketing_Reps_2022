...
$sql ="UPDATE international_company SET companyname='$name',phone='$phone',website='$website',location='$address',establishedyear='$establishedyear' WHERE id='$dan'";
...
$sqll ="SELECT * FROM international_company WHERE id='$dan'";
...
<!--				  <div class="form-group">
          ...
          $canu=$_SESSION['canDELL'];
            ...
            {
?>
           <a href="del.php?iduser=<?php echo $roww['id'];?>&tbuser=international_company"><label style="background-color:red; float:left;" name="Delete" class="btn btn-primary"> Delete </label></a> 
    <?php
            }
            ?>
