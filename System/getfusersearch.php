...
$sqllas = "SELECT * FROM users WHERE (company LIKE '%$srch%' OR email LIKE '%$srch%' OR name LIKE '%$srch%' OR country LIKE '%$srch%' OR city LIKE '%$srch%' OR phone LIKE '%$srch%' OR website LIKE '%$srch%'  OR role LIKE '%$srch%') && DEL='0' && role!='admin'";
