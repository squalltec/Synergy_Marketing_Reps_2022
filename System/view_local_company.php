...
$sqlla ="SELECT * FROM local_company WHERE DEL='0'";
...
<div onclick="location.href='edit_local_company.php?dan=<?php echo $rowwa["id"];?>';" style="cursor: pointer;" align="center" class="containeer gallery">



    <img src="Local Company Lisences/<?php echo $rowwa["logo"];?>" alt="">
...
$sqllaf ="SELECT * FROM countries WHERE id='$ads'";
...
echo $conty;
 ...
 ?></p>
<a href="https://<?php echo $rowwa["email"];?>"><p align="center" class="f" style="color:white !important; font-size:100%;"> <?php echo $rowwa["website"];?></p></a>
 </div>
