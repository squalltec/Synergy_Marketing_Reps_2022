...
if ($resultarr === TRUE) {
  ...
  echo "Error: " . $sqlStrr . "<br>" . $conn->error;
	...
	mkdir("International Company Lisences/".$companyname);	
	  ...
	  $destination = 'International Company Lisences/' . $filename;
...
$sql ="INSERT INTO international_company (companyname,establishedyear,staffstrength,location,lat,longg,branches,logo,phone,website,country,city) VALUES ('$companyname', '$establishedyear','$staffstrength','$location','$lat','$long','$branches','$filename','$phone','$website','$countryname','$cityname')";
...
$sqlTpl = "INSERT INTO internationalactivity ( name,country,city,address,activity)
           VALUES (%s )";
...
if ($resultar === TRUE) {
    ...
    echo ("<script>location.href='decider2.html'</script>");
      ...
      <div class="content-wrapper">
        ...
        <section style='background-color:#222;' class="content-header">
          ...
          <ol style='color:white;' class="breadcrumb">
            ...
            <li style='color:white;'><a style='color:white;' href="#">International Database</a></li>
 ...
 var p="";
   ...
   $("#companyc").on('change', function() {
	...
	var co= $("#companyc").val();
	 ...
	 $.ajax({
              type:'POST',
              url:'validate_international_company.php',
              data:{'co':co},
