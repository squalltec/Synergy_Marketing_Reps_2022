...
$sqllas = "SELECT * FROM customer WHERE (name LIKE '%$srch%' OR company LIKE '%$srch%' OR country LIKE '%$srch%' OR city LIKE '%$srch%' OR designation LIKE '%$srch%' OR department LIKE '%$srch%') && DEL='0'";
...
<div onclick="location.href='update_customers.php?dan=<?php echo $row['id'];?>';" style="cursor: pointer;" align="center" class="containeer gallery">



    <img src="Customer Images/<?php echo $row["image"];?>" alt="">
