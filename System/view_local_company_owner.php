...
$sqlla ="SELECT * FROM local_company WHERE DEL='0' && createdbycompanyid='$usidd'";
...
<div onclick="location.href='edit_local_company_owner.php?dan=<?php echo $rowwa["id"];?>';" style="cursor: pointer;" align="center" class="containeer gallery">
