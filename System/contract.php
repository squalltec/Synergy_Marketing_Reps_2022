...
<select required name="payableby">
...
<select id="paymenttype" required name="payableby">
<option>Select Payment</option>
<option>A</option>
<option>B</option>
</select>
...
-->
 ...
 <div class="box-footer">
                    ...
                    <input style="float:left;"type="button" id="repp" value="Print Secondary Contract" class="btn btn-info btn_print_secondary">
                 
                 
                    <input style="float:right;"type="button" id="rep" value="Print Franchise Contract" class="btn btn-info btn_print">
                  </div>
