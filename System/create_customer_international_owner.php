...
$dan=	 $_POST['username'];
	...
	mkdir("International Customer Images/".$dan);	
	  ...
	  $destination = 'International Customer Images/'. $dan . '/' . $filename;
...
if ($result === TRUE) {
   ...
   echo ("<script>location.href='decider2_owner.html'</script>");
      ...
      <div class="content-wrapper">
        ...
        <section style='background-color:#222;' class="content-header">
          ...
          <ol style='color:white;' class="breadcrumb">
            ...
            <li  style='color:white;' ><a  style='color:white;' href="#">International Customers</a></li>
      	...
      	<label class="text-label form-label">Company*</label>
            ...
            <?php 
              ...
              $mycom= $_SESSION['company'];
                ...
                $resultt=mysqli_query($conn,"SELECT id,companyname FROM international_company WHERE createdbycompanyid='$achaid'"); 
...
<script>
 ...
 var ppp="";
	...
	var	compy1 = $("#company").val();
	  ...
	  $.ajax({
              type:'POST',
              url:'getcustomercountryinternational.php',
              data:{'compy1':compy1},
	  ...
	  $.ajax({
              type:'POST',
              url:'getcustomercityinternational.php',
              data:{'compyy1':compy1},
              success:function(result){
          ...
          $.ajax({
              type:'POST',
              url:'getcustomerwebsiteinternational.php',
	  ...
	  $.ajax({
              type:'POST',
              url:'getcustomerphonecodeinternational.php',
   ...
   $("#designation").on('change', function() {
	...
	var dep= $("#department").val();
	 ...
	 $.ajax({
              type:'POST',
              url:'validate_international_customer.php',
